# ------------------------------------------------------------------------
# False negative analysis by Alwassel et al.
...
def false_negative_analysis(ground_truth_filename, subset, prediction_filename, output_folder, is_thumos14):
...
if __name__ == '__main__':
    ...
    false_negative_analysis(args.ground_truth_filename, args.subset, args.prediction_filename, args.output_folder, args.is_thumos14)
